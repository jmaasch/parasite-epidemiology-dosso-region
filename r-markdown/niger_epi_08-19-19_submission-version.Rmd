...
Load data. Original Giardia merging was done in Stata, later this file was merged with anthropometric data from 
Salesforce and Schisto data. Took clean data from swab comparison manuscript. Merged script is called "GiardiaAnthroShistoMerge.R".
```{r data}
...
#ggsave("/Users/razel/Dropbox/Niger parasite epi/Data/Exported figures/prev_age_sex.jpg", 
        plot = last_plot(), width = 8, height = 6, dpi = 1000)
```
